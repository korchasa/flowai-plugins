...
description: >-
  Git diff analysis specialist. Analyzes changes, groups them into logical
  hunks, and prepares summaries for atomic commits. Use proactively during
  flowai-commit to minimize context usage by delegating detailed diff analysis.
