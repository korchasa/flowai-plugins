...
name: plan
description: >-
  Use ONLY when the user explicitly asks to plan a task, create a task file in
  documents/tasks/, produce a GODS-format breakdown, or prepare a critiqued
  implementation strategy before coding. Do NOT trigger on brief design
