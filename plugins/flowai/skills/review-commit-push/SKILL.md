...
<!-- GENERATED FROM framework/composites/review-commit-push.md, framework/atoms/review.md, framework/atoms/commit.md, framework/atoms/push.md, framework/atoms/reflect-gate.md via scripts/generate-skill-composites.ts — DO NOT EDIT BY HAND -->
